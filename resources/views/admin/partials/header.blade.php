<header id="header">
    ...
    <div class="header-search map">
        ...
        @yield('page-banner')
        {{--mobile navbar--}}
        <div class="header-nav-bar hidden-lg hidden-md">
            <div class="container">
                <nav class="">
                    ...
                    <ul class="primary-nav list-unstyled">
                        ...
                        @else
                            ...
                            @endif
                            <li class="hidden-lg hidden-md dropdown text-center">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" id="menu3">
                                    <i class="fa fa-user"></i> Pages <span class="caret"></span>
                                </a>
                                <ul class="dropdown-menu text-center" role="menu" aria-labelledby="menu3">
