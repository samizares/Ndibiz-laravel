                ...
                <div class="container">                  
                  <div class="search-value">
                    ...
                    <div class="category-search">
                      <select id="category" name="category" placeholder="Search by categories here..."></select> 
                    </div>
                    ...
                    <div class="select-location input-group">
                      ...
                      <select class="form-control" id="location" name="location" placeholder="Choose a city/area..."></select>                     
                    </div>
